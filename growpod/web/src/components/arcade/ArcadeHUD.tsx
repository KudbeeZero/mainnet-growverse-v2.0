...
export function ArcadeHUD({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[max(5.5rem,calc(env(safe-area-inset-bottom)+5rem))] z-40 flex flex-col items-center gap-2 px-3">
      ...
      {/* Main panel. */}
      <div className="pointer-events-auto flex w-full max-w-md flex-col gap-2 rounded-2xl border border-cyan-400/30 bg-[#08141e]/85 p-2.5 shadow-lg backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          ...
          {onClose && (
            <button
              onClick={onClose}
              aria-label="Hide arcade controls"
