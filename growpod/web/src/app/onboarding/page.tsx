...
import { GrowthIntroScene } from "@/components/intro/GrowthIntroScene";
    ...
    <div className="py-6">
      ...
      <div className="grid items-center gap-8 lg:grid-cols-2">
        <div>
          ...
          {/* Living plant inspected by AI scouts — click a scout to summon help. */}
          <div className="instrument-label mb-3 text-center text-gray-600 motion-reduce:hidden">
            AI SCOUTS · CLICK TO SUMMON A SPECIALIST
          </div>
          <GrowthIntroScene />
          <div className="mt-5">
